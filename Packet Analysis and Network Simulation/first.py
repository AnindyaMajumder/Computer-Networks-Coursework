...
anim = ns.netanim.AnimationInterface("scratch/2048.xml")
pointToPoint.EnablePcapAll("scratch/2048")
#anim = ns.netanim.AnimationInterface("scratch/1024.xml")
#pointToPoint.EnablePcapAll("scratch/1024")
#anim = ns.netanim.AnimationInterface("scratch/512.xml")
#pointToPoint.EnablePcapAll("scratch/512")
#anim = ns.netanim.AnimationInterface("scratch/256.xml")
#pointToPoint.EnablePcapAll("scratch/256")
#anim = ns.netanim.AnimationInterface("scratch/128.xml")
#pointToPoint.EnablePcapAll("scratch/128")
